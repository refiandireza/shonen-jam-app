...
class RankingUnit extends HTMLElement {
  set item(item) {
    this._item = item;
    this.render();
  }
  ...
  render() {
    ...
    this.innerHTML = `
            <li class="ranking-unit d-flex align-items-start">
              <img src="${this._item.image_url}" loading="lazy" class="img-fluid lazy-load me-1" alt="">
              <div class="data">
                <div class="clearfix">
                  <a href="#" class="title float-start" data-id="${this._item.mal_id}">${this._item.title}</a>
                  <a href="#" class="button-add-ranking float-end">add</a>
                </div>
                <span class="info">${this._item.type}, ${this._item.episodes !== null ? this._item.episodes : '0'} eps, scored ${this._item.score}</span>
                <span class="members">${this._item.members.toLocaleString()} members</span>
              </div>
            </li>
        `;
        ...
        itemElement.innerHTML = `
          <div class="img-wrapper">
            ...
            <div class="text">
              ...
              <p>Voice Actor: <span>${voice_actors[0] ? voice_actors[0].name : '-'}</span></p>
            </div>
        `;
    ...
    // card onclick
    const cardAnime = this.querySelector('.title');
...
customElements.define('ranking-unit', RankingUnit);
